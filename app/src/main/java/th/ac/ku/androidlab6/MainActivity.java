...
//        findViewById(R.id.dummy_button).setOnTouchListener(mDelayHideTouchListener);
    ...
    private void initInstance() {
        num1EditText = (EditText) findViewById(R.id.et_num1);
        num2EditText = (EditText) findViewById(R.id.et_num2);
        num3EditText = (EditText) findViewById(R.id.et_num3);
        num4EditText = (EditText) findViewById(R.id.et_num4);
        num5EditText = (EditText) findViewById(R.id.et_num5);
        ...
        createChartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("num5", Double.parseDouble(num5EditText.getText().toString()));
